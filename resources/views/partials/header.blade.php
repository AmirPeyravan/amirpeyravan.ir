    ...
    <div class="grid-overlay">
        ...
        <div class="relative z-10 text-center">
            ...
            <div class="flex justify-center space-x-4 space-x-reverse mb-8">
                <a href="https://www.linkedin.com/in/amirpeyravan" class="social-icon text-gray-300 hover:text-white h-12 w-12 bg-gray-800 rounded-full flex items-center justify-center transition-all">
                    <i class="fab fa-linkedin-in text-xl"></i>
                </a>
                <a href="https://www.x.com/amirpeyravan" class="social-icon text-gray-300 hover:text-white h-12 w-12 bg-gray-800 rounded-full flex items-center justify-center transition-all">
                    <i class="fab fa-twitter text-xl"></i>
                </a>
                <a href="https://www.instagram.com/amirpeyravan" class="social-icon text-gray-300 hover:text-white h-12 w-12 bg-gray-800 rounded-full flex items-center justify-center transition-all">
                    <i class="fab fa-instagram text-xl"></i>
                </a>
                <a href="https://github.com/amirpeyravan" class="social-icon text-gray-300 hover:text-white h-12 w-12 bg-gray-800 rounded-full flex items-center justify-center transition-all">
                    <i class="fab fa-github text-xl"></i>
                </a>
                <a href="https://www.reddit.com/user/amirpeyravan" class="social-icon text-gray-300 hover:text-white h-12 w-12 bg-gray-800 rounded-full flex items-center justify-center transition-all">
